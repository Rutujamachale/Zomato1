...
const RestaurantDetails11 = () => {
  ...
  return (
    <div className="restaurant-detail-container">
      <button onClick={() => navigate(-1)} className="back-button">⬅ Go Back</button>
      <h1 className="restaurant-title">{restaurant.restaurant}</h1>
      <img src={restaurant.img || "/default-restaurant.jpg"} alt={restaurant.restaurant} className="restaurant-detail-image" />
      <p className="restaurant-city">📍 Location: {restaurant.city}</p>
...
export default RestaurantDetails11;